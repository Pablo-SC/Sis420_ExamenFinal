...
2 Redes Neuronales:
	* El primer ejercicio es de regresion para calcular el precio de venta de casas, usando redes neuronales
	* El segundo ejercicio es una clasificacion multivariable que busca clasificar la salud de fetos para prevenir la mortalidad de niño y madre
